...
type IAMAPI interface {
	...
	GetRole(ctx context.Context, params *iam.GetRoleInput, optFns ...func(*iam.Options)) (*iam.GetRoleOutput, error) // WO-107@v2: recover usage evidence omitted by ListRoles.
